...
public class SearchIndexManager<R extends IndexReader>{
    ...
    public List<ZoieIndexReader<R>> getIndexReaders()
	      throws IOException
	  {
        ...
        LongSet memDelSet = null;
        LongSet diskDelSet = null;
        Mem<R> mem = _mem;
        ...
        if (memIndexB != null)                           // load memory index B
        {
          ...
          if (reader != null)
          {
            ...
            {
              diskDelSet = new LongOpenHashSet(memDelSet);
            }
            readers.add(reader);
          }
        }
        ...
        if (memIndexA != null)                           // load memory index A
        {
          ...
          if (reader != null)
	      {
        	LongSet tmpDelSet = reader.getModifiedSet();
	        if(diskDelSet == null)
	        {
	        ...
	        reader.setDelSet(memDelSet != null ? new LongOpenHashSet(memDelSet) : null);
            readers.add(reader);
	      }
	    }
	    if (_diskIndex != null)                           // load disk index
	      ...
	      if (reader != null)
	      {
	    	InternalIndexReader<R> r = (InternalIndexReader<R>)reader;
	    	r.incrementRef();
	        reader.setDelSet(diskDelSet != null ? new LongSetAccelerator(diskDelSet) : null);
            readers.add(reader);
	      }
	    }
	    return readers;
