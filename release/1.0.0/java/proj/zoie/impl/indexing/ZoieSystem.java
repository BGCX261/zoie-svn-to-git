...
public class ZoieSystem<R extends IndexReader,V> implements DataConsumer<V>,IndexReaderFactory<R> {
	...
	public void consume(Collection<DataEvent<V>> data) throws ZoieException {
		synchronized(_delegateConsumer)
		{
		  _delegateConsumer.consume(data);
		}
	}
