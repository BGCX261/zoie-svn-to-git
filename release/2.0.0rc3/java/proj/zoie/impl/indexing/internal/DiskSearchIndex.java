...
public class DiskSearchIndex<R extends IndexReader> extends BaseSearchIndex<R>{
  ...
  DiskSearchIndex(File location, IndexReaderDecorator<R> decorator,SearchIndexManager<R> idxMgr){
    super(idxMgr);  
    _location = location;
    _mergePolicyParams = new MergePolicyParams();
    _dispenser = new IndexReaderDispenser<R>(_location, decorator,this);
