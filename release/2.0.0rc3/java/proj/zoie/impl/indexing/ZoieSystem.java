...
public class ZoieSystem<R extends IndexReader,V> extends AsyncDataConsumer<V> implements DataConsumer<V>,IndexReaderFactory<ZoieIndexReader<R>> {
	...
	public static long getCurrentVersion(File idxHome) throws IOException{
		IndexSignature sig = IndexReaderDispenser.getCurrentIndexSignature(idxHome);
	...
	{
		return getCurrentVersion(_idxDir);
	}
