...
/**
 * This class, a LongSet decorator, is for accelerating look-up by having a filter 
 * in front of the underlying LongSet. The filter is basically a Bloom filter.
 * The hash table size and the hash function are tuned for fast calculation of hash values.
 * The underlying LongSet should not be updated while this accelerator is in use.
 * 
 * @author ymatsuda
 *
 */
