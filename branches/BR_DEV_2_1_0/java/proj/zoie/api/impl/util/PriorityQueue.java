...
public class PriorityQueue<T> extends AbstractQueue<T>
{
   ...
   * @param class1 the Class<T> instance of the type of the items in the queue. This is used to create an array of the appropriate type.
...
//    System.out.println("creating pri queue of capacity " + capacity + " comp " + comparator + " " + Thread.currentThread() );
  }
...
//    System.out.println("adding  to queue " + item + "  \t  " +Thread.currentThread().getClass()+Thread.currentThread().getId() );
  ...
  public T peek()
  {
    if (_size == 0)
      return null;
//    System.out.println("peeking to queue " + _items[0] + "  \t  " +Thread.currentThread().getClass()+Thread.currentThread().getId() );
    return _items[0];
  }
  ...
  public T poll()
  {
    ...
    if (_size > 1)
      percolateDown();
//    System.out.println("polling to queue " + ret + "  \t  " +Thread.currentThread().getClass()+Thread.currentThread().getId() );
    return ret;
  }
