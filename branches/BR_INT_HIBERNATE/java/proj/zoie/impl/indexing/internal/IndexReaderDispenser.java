...
public class IndexReaderDispenser {
	...
	private volatile InternalIndexReader _oldReader;
	...
	/**
	   ...
	   * @throws IOException
	   */
	  private static InternalIndexReader newReader(File luceneDir, IndexReaderDecorator<?> decorator, IndexSignature signature)
	      throws IOException
	  {
